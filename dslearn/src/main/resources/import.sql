...
INSERT INTO TB_RESOURCE ( DESCRIPTION , EXTERNAL_LINK , IMG_URI , POSITION , TITLE , TYPE , OFFER_ID ) VALUES ( 'Test resource 1' , '' , 'https://upload.wikimedia.org/wikipedia/commons/3/3b/Javascript_Logo.png' , 1 , 'Javascript' , 1 , 1 );
INSERT INTO TB_RESOURCE ( DESCRIPTION , EXTERNAL_LINK , IMG_URI , POSITION , TITLE , TYPE , OFFER_ID ) VALUES ( 'Test resource 2' , '' , 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSS9v00g4XP1X0sFzxp64FIBSIgchtoRkAZSj_fjzq75u16gd3RcOmWYHJazTTHc6WSt30&usqp=CAU' , 1 , 'Html 5' , 1 , 1 );
INSERT INTO TB_RESOURCE ( DESCRIPTION , EXTERNAL_LINK , IMG_URI , POSITION , TITLE , TYPE , OFFER_ID ) VALUES ( 'Test resource 3' , '' , 'https://upload.wikimedia.org/wikipedia/commons/d/d5/CSS3_logo_and_wordmark.svg' , 1 , 'CSS 3' , 1 , 1 );